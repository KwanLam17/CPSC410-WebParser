...
public class Tokenizer {
    ...
    //          this might mean you need to strip off spaces *around* tokens during parsing (ick)
...
//        System.out.println(Arrays.asList(tokens));
    ...
    //          so if you want to preserve spaces within tokens, use the spaceHappyTokenize method (above) instead
